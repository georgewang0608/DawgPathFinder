...
public class GraphTestDriver {
    ...
    private void addNode(String graphName, String nodeName) {
        // TODO Insert your code here.
         ...
         DirectedLabeledGraph<String, String> nodes = graphs.get(graphName);
    ...
    private void addEdge(String graphName, String parentName, String childName,
        ...
        DirectedLabeledGraph<String, String> edges = graphs.get(graphName);
        ...
        DirectedLabeledGraph.Edge<String, String> edge = new DirectedLabeledGraph.Edge<>(parent, child, edgeLabel);
        edges.addEdge(edge);
    ...
    private void listNodes(String graphName) {
        // TODO Insert your code here.
         ...
         List<DirectedLabeledGraph.Node<String>> nodes = graph.listNode();
         Set<String> values = new TreeSet<>();
         for (DirectedLabeledGraph.Node<String> i : nodes) {
         ...
         output.println(graphName + " contains:" + outputs);
    }
    ...
    private void listChildren(String graphName, String parentName) {
        // TODO Insert your code here.
        DirectedLabeledGraph<String, String> graph = graphs.get(graphName);
        DirectedLabeledGraph.Node<String> node = new DirectedLabeledGraph.Node<>(parentName);
        List<DirectedLabeledGraph.Edge<String, String>> edges = graph.listChildren(node);
        Set<String> values = new TreeSet<>();
        String outputs = "";
        for (DirectedLabeledGraph.Edge<String, String> i : edges) {
            values.add(" " + i.getChild().getValue() + "(" + i.getLabel() + ")");
        }
        for (String i : values) {
            outputs += i;
        }
        output.println("the children of " + parentName + " in " + graphName + " are:" + outputs);
    }
